    ...
    <div class="app-container">
        ...
        <el-dialog :title="title" :visible.sync="open" width="1000px">
            ...
            <el-steps :active="activeSteps" align-center>
                <el-step class="moveSteps" title="添加用户" description="添加用户登录信息" @click.native="stepActive(1)"/>
                <el-step class="moveSteps" title="完善用户档案" description="填写用户详细信息" @click.native="stepActive(2)"/>
                <el-step class="moveSteps" title="绑定RFID卡片" description="用户实名制系统登记" @click.native="stepActive(3)"/>
...
<!--                        </el-col>-->
                        ...
                        <!--                            <el-button class="rfid_btn" :disabled="rfid_status" type="text" v-if="form.userInfo.RFIDId == null ? (temp_rfid_value = '点击绑定RFID卡片') : ((temp_rfid_value = form.userInfo.RFIDId) && (rfid_status = true))" @click="handBindRFID(form.userInfo.id)">-->
                        <!--                                {{ temp_rfid_value }}-->
                        <!--                            </el-button>-->
                        <!--                        </el-form-item>-->
                        <!--                    </el-col>-->
            ...
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" @click="nextSteps">继 续</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 步骤条，继续
            nextSteps() {
                // if ((this.activeSteps++) >= 3) this.activeSteps = 1;
            ...
            // 点击绑卡
            handBindRFID(id) {
                this.$confirm('此操作将为用户绑定RFID卡片，等待刷卡60S, 是否继续?', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
