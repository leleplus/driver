<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="用户" prop="userinfoId" :show-overflow-tooltip="true" width="150"/>
            <el-table-column label="刷卡类型" prop="swipeType" width="100"/>
            <el-table-column label="活动状态" prop="status" width="200"/>
            <el-table-column label="活动内容" prop="action" width="200"/>
...
<script>
    import {listSwipeRecord} from '@/api/system/rfid'

    export default {
        name: "SwipeRFIDRecord",
        data() {
            return {
                // 遮罩层
                loading: true,
