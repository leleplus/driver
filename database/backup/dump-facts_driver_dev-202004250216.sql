...
--
-- Host: localhost    Database: facts_driver_dev
-- ------------------------------------------------------
...
INSERT INTO `qrtz_cron_triggers` VALUES ('DriverScheduler','TASK_CLASS_NAME1','DEFAULT','0/10 * * * * ?','Asia/Shanghai'),('DriverScheduler','TASK_CLASS_NAME2','DEFAULT','0/15 * * * * ?','Asia/Shanghai'),('DriverScheduler','TASK_CLASS_NAME3','DEFAULT','0/20 * * * * ?','Asia/Shanghai'),('RuoYiScheduler','TASK_CLASS_NAME1','DEFAULT','0/10 * * * * ?','Asia/Shanghai'),('RuoYiScheduler','TASK_CLASS_NAME2','DEFAULT','0/15 * * * * ?','Asia/Shanghai'),('RuoYiScheduler','TASK_CLASS_NAME3','DEFAULT','0/20 * * * * ?','Asia/Shanghai');
...
INSERT INTO `qrtz_locks` VALUES ('DriverScheduler','STATE_ACCESS'),('DriverScheduler','TRIGGER_ACCESS'),('RuoYiScheduler','STATE_ACCESS'),('RuoYiScheduler','TRIGGER_ACCESS');
...
INSERT INTO `qrtz_scheduler_state` VALUES ('DriverScheduler','DESKTOP-M9S9U4T1587750892314',1587751615944,15000),('RuoYiScheduler','DESKTOP-M9S9U4T1585744321895',1585744620242,15000);
...
INSERT INTO `qrtz_triggers` VALUES ('DriverScheduler','TASK_CLASS_NAME1','DEFAULT','TASK_CLASS_NAME1','DEFAULT',NULL,1587751850000,-1,5,'PAUSED','CRON',1587751846000,0,NULL,2,''),('DriverScheduler','TASK_CLASS_NAME2','DEFAULT','TASK_CLASS_NAME2','DEFAULT',NULL,1587751860000,-1,5,'PAUSED','CRON',1587751846000,0,NULL,2,''),('DriverScheduler','TASK_CLASS_NAME3','DEFAULT','TASK_CLASS_NAME3','DEFAULT',NULL,1587751860000,-1,5,'PAUSED','CRON',1587751846000,0,NULL,2,''),('RuoYiScheduler','TASK_CLASS_NAME1','DEFAULT','TASK_CLASS_NAME1','DEFAULT',NULL,1585744330000,-1,5,'PAUSED','CRON',1585744322000,0,NULL,2,''),('RuoYiScheduler','TASK_CLASS_NAME2','DEFAULT','TASK_CLASS_NAME2','DEFAULT',NULL,1585744335000,-1,5,'PAUSED','CRON',1585744322000,0,NULL,2,''),('RuoYiScheduler','TASK_CLASS_NAME3','DEFAULT','TASK_CLASS_NAME3','DEFAULT',NULL,1585744340000,-1,5,'PAUSED','CRON',1585744322000,0,NULL,2,'');
...
CREATE TABLE `rfid_card` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='RFID卡登记表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rfid_card` VALUES (1,'89041DB3','','','','管理员授权',1,'2020-04-20 06:40:55','','',NULL,NULL,NULL,'自动创建'),(2,'C33D0E40','','','','管理员授权',1,'2020-04-20 07:18:02','','',NULL,NULL,NULL,'自动创建'),(3,'C33D0E40','','','','管理员授权',1,'2020-04-25 02:05:22','','',NULL,NULL,NULL,'自动创建');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='刷卡记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'facts_driver_dev'
--

--
-- Dumping routines for database 'facts_driver_dev'
--
...
-- Dump completed on 2020-04-25  2:16:10
