...
CREATE TABLE `driver_license` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='驾驶证类型表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `swipe_rfid_record` (
  ...
  CONSTRAINT `swipe_rfid_record_fk` FOREIGN KEY (`rfid_id`) REFERENCES `user_rfid` (`id`),
  CONSTRAINT `swipe_rfid_record_fk_1` FOREIGN KEY (`user_info_id`) REFERENCES `sys_user_info` (`id`)
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`),
  KEY `sys_menu_fk` (`parent_id`),
  CONSTRAINT `sys_menu_fk` FOREIGN KEY (`parent_id`) REFERENCES `sys_menu` (`menu_id`)
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_role_menu` (
  ...
  CONSTRAINT `sys_role_menu_fk_1` FOREIGN KEY (`menu_id`) REFERENCES `sys_menu` (`menu_id`)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户RFID关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-04-11 17:51:42
