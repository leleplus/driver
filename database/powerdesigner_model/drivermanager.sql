...
(
   id                   bigint(255) not null comment '用户操作记录表主键',
   user_id              bigint(255) comment '用户表id',
...
(
   id                   bigint(255) not null comment '车辆信息表主键',
...
(
   id                   bigint(255) not null comment '教练表主键',
   user_id              bigint(255) comment '用户表外键',
   realname             varchar(50) comment '真实姓名',
...
(
   id                   bigint(255) not null comment '练车表主键',
   student_archive_id   bigint(255) comment '学员表id',
...
(
   id                   bigint(255) not null comment '学员表主键',
   user_id              bigint(255) comment '用户表外键',
   realname             varchar(50) comment '真实姓名',
   birthday             varchar(255) comment '出生日期',
...
(
   id                   bigint(255) not null comment '科目表主键',
   student_archive_id   bigint(255) comment '学员表id',
   sub_name             varchar(200) comment '科目名称',
...
(
   ...
   role_code            varchar(40) comment '角色编码(角色标识)',
